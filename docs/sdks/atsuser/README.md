...
* [add_ats_users](#add_ats_users) - Add a batch of Users
...
res = s.ats_user.add_ats_users(connection_token='<value>', x_connection_token='<value>', request_body=[
...
**[operations.AddAtsUsersResponse](../../models/operations/addatsusersresponse.md)**
### Errors
