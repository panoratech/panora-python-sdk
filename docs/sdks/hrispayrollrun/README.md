...
* [add_payroll_runs](#add_payroll_runs) - Add a batch of PayrollRuns
...
res = s.hris_payrollrun.add_payroll_runs(connection_token='<value>', x_connection_token='<value>', request_body=[
    components.UnifiedPayrollRunInput(),
], remote_data=False)
...
| `x_connection_token`                                                                         | *str*                                                                                        | :heavy_check_mark:                                                                           | The connection token                                                                         |
| `request_body`                                                                               | List[[components.UnifiedPayrollRunInput](../../models/components/unifiedpayrollruninput.md)] | :heavy_check_mark:                                                                           | N/A                                                                                          |
| `remote_data`                                                                                | *Optional[bool]*                                                                             | :heavy_minus_sign:                                                                           | Set to true to include data from the original Hris software.                                 |


### Response

**[operations.AddPayrollRunsResponse](../../models/operations/addpayrollrunsresponse.md)**
### Errors
