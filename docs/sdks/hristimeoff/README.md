...
* [add_timeoffs](#add_timeoffs) - Add a batch of Timeoffs
...
res = s.hris_timeoff.add_timeoffs(connection_token='<value>', x_connection_token='<value>', request_body=[
    components.UnifiedTimeoffInput(),
], remote_data=False)
...
**[operations.AddTimeoffsResponse](../../models/operations/addtimeoffsresponse.md)**
### Errors
