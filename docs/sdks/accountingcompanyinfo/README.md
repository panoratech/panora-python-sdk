...
* [add_company_infos](#add_company_infos) - Add a batch of CompanyInfos
...
res = s.accounting_companyinfo.add_company_infos(connection_token='<value>', x_connection_token='<value>', request_body=[
    components.UnifiedCompanyInfoInput(),
], remote_data=False)
...
| `x_connection_token`                                                                           | *str*                                                                                          | :heavy_check_mark:                                                                             | The connection token                                                                           |
| `request_body`                                                                                 | List[[components.UnifiedCompanyInfoInput](../../models/components/unifiedcompanyinfoinput.md)] | :heavy_check_mark:                                                                             | N/A                                                                                            |
| `remote_data`                                                                                  | *Optional[bool]*                                                                               | :heavy_minus_sign:                                                                             | Set to true to include data from the original Accounting software.                             |


### Response

**[operations.AddCompanyInfosResponse](../../models/operations/addcompanyinfosresponse.md)**
### Errors
