...
class GetTicketingAccountsRequest:
...
@dataclasses.dataclass
class GetTicketingAccountsResponseBody:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetTicketingAccountsResponse:
    http_meta: components_httpmetadata.HTTPMetadata = dataclasses.field(metadata={'dataclasses_json': { 'exclude': lambda f: True }})
    object: Optional[GetTicketingAccountsResponseBody] = dataclasses.field(default=None)
