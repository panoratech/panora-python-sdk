...
class AddOfficeRequest:
    ...
    unified_office_input: components_unifiedofficeinput.UnifiedOfficeInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AddOfficeResponse:
    http_meta: components_httpmetadata.HTTPMetadata = dataclasses.field(metadata={'dataclasses_json': { 'exclude': lambda f: True }})
    object: Optional[AddOfficeResponseBody] = dataclasses.field(default=None)
    unified_office_output: Optional[components_unifiedofficeoutput.UnifiedOfficeOutput] = dataclasses.field(default=None)
