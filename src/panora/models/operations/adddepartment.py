...
class AddDepartmentRequest:
    ...
    unified_department_input: components_unifieddepartmentinput.UnifiedDepartmentInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
@dataclasses.dataclass
class AddDepartmentResponseBody:
...
class AddDepartmentResponse:
    ...
    object: Optional[AddDepartmentResponseBody] = dataclasses.field(default=None)
    unified_department_output: Optional[components_unifieddepartmentoutput.UnifiedDepartmentOutput] = dataclasses.field(default=None)
