...
class AddNoteRequest:
    ...
    unified_note_input: components_unifiednoteinput.UnifiedNoteInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class AddNoteResponse:
    ...
    object: Optional[AddNoteResponseBody] = dataclasses.field(default=None)
    unified_note_output: Optional[components_unifiednoteoutput.UnifiedNoteOutput] = dataclasses.field(default=None)
