...
class AddAccountingContactRequest:
...
@dataclasses.dataclass
class AddAccountingContactResponseBody:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AddAccountingContactResponse:
    http_meta: components_httpmetadata.HTTPMetadata = dataclasses.field(metadata={'dataclasses_json': { 'exclude': lambda f: True }})
    object: Optional[AddAccountingContactResponseBody] = dataclasses.field(default=None)
