...
from ...models.components import unifieddepartmentinput as components_unifieddepartmentinput
...
class AddDepartmentsRequest:
    ...
    request_body: List[components_unifieddepartmentinput.UnifiedDepartmentInput] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
@dataclasses.dataclass
class AddDepartmentsResponseBody:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AddDepartmentsResponse:
    http_meta: components_httpmetadata.HTTPMetadata = dataclasses.field(metadata={'dataclasses_json': { 'exclude': lambda f: True }})
    object: Optional[AddDepartmentsResponseBody] = dataclasses.field(default=None)
    unified_department_outputs: Optional[List[components_unifieddepartmentoutput.UnifiedDepartmentOutput]] = dataclasses.field(default=None)
