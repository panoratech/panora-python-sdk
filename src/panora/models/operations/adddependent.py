...
class AddDependentRequest:
    ...
    unified_dependent_input: components_unifieddependentinput.UnifiedDependentInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
@dataclasses.dataclass
class AddDependentResponseBody:
...
class AddDependentResponse:
    ...
    object: Optional[AddDependentResponseBody] = dataclasses.field(default=None)
    unified_dependent_output: Optional[components_unifieddependentoutput.UnifiedDependentOutput] = dataclasses.field(default=None)
