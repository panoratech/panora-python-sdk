...
class AddActivityRequest:
    ...
    unified_activity_input: components_unifiedactivityinput.UnifiedActivityInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class AddActivityResponse:
    ...
    object: Optional[AddActivityResponseBody] = dataclasses.field(default=None)
    unified_activity_output: Optional[components_unifiedactivityoutput.UnifiedActivityOutput] = dataclasses.field(default=None)
