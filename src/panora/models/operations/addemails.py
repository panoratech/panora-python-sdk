...
from ...models.components import unifiedemailinput as components_unifiedemailinput
...
class AddEmailsRequest:
    ...
    request_body: List[components_unifiedemailinput.UnifiedEmailInput] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AddEmailsResponse:
    http_meta: components_httpmetadata.HTTPMetadata = dataclasses.field(metadata={'dataclasses_json': { 'exclude': lambda f: True }})
    object: Optional[AddEmailsResponseBody] = dataclasses.field(default=None)
    unified_email_outputs: Optional[List[components_unifiedemailoutput.UnifiedEmailOutput]] = dataclasses.field(default=None)
