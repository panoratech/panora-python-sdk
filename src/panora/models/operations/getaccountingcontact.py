...
class GetAccountingContactRequest:
...
@dataclasses.dataclass
class GetAccountingContactResponseBody:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetAccountingContactResponse:
    http_meta: components_httpmetadata.HTTPMetadata = dataclasses.field(metadata={'dataclasses_json': { 'exclude': lambda f: True }})
    object: Optional[GetAccountingContactResponseBody] = dataclasses.field(default=None)
