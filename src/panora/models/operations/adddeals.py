...
from ...models.components import unifieddealinput as components_unifieddealinput
...
class AddDealsRequest:
    ...
    request_body: List[components_unifieddealinput.UnifiedDealInput] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AddDealsResponse:
    http_meta: components_httpmetadata.HTTPMetadata = dataclasses.field(metadata={'dataclasses_json': { 'exclude': lambda f: True }})
    object: Optional[AddDealsResponseBody] = dataclasses.field(default=None)
    unified_deal_outputs: Optional[List[components_unifieddealoutput.UnifiedDealOutput]] = dataclasses.field(default=None)
