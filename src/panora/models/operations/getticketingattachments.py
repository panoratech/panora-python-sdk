...
class GetTicketingAttachmentsRequest:
...
@dataclasses.dataclass
class GetTicketingAttachmentsResponseBody:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetTicketingAttachmentsResponse:
    http_meta: components_httpmetadata.HTTPMetadata = dataclasses.field(metadata={'dataclasses_json': { 'exclude': lambda f: True }})
    object: Optional[GetTicketingAttachmentsResponseBody] = dataclasses.field(default=None)
