...
class AddMarketingAutomationContactsRequest:
...
@dataclasses.dataclass
class AddMarketingAutomationContactsResponseBody:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AddMarketingAutomationContactsResponse:
    http_meta: components_httpmetadata.HTTPMetadata = dataclasses.field(metadata={'dataclasses_json': { 'exclude': lambda f: True }})
    object: Optional[AddMarketingAutomationContactsResponseBody] = dataclasses.field(default=None)
