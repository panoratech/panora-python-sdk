...
class AddCommentRequest:
    ...
    unified_comment_input: components_unifiedcommentinput.UnifiedCommentInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class AddCommentResponse:
    ...
    object: Optional[AddCommentResponseBody] = dataclasses.field(default=None)
    unified_comment_output: Optional[components_unifiedcommentoutput.UnifiedCommentOutput] = dataclasses.field(default=None)
