...
from ...models.components import unifiednoteinput as components_unifiednoteinput
...
class AddNotesRequest:
    ...
    request_body: List[components_unifiednoteinput.UnifiedNoteInput] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class AddNotesResponse:
    ...
    object: Optional[AddNotesResponseBody] = dataclasses.field(default=None)
    unified_note_outputs: Optional[List[components_unifiednoteoutput.UnifiedNoteOutput]] = dataclasses.field(default=None)
