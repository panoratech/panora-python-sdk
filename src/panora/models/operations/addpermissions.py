...
class AddPermissionsRequest:
    ...
    request_body: List[components_unifiedpermissioninput.UnifiedPermissionInput] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
@dataclasses.dataclass
class AddPermissionsResponseBody:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AddPermissionsResponse:
    http_meta: components_httpmetadata.HTTPMetadata = dataclasses.field(metadata={'dataclasses_json': { 'exclude': lambda f: True }})
    object: Optional[AddPermissionsResponseBody] = dataclasses.field(default=None)
    unified_permission_outputs: Optional[List[components_unifiedpermissionoutput.UnifiedPermissionOutput]] = dataclasses.field(default=None)
