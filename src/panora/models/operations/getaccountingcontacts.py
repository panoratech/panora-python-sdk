...
class GetAccountingContactsRequest:
...
@dataclasses.dataclass
class GetAccountingContactsResponseBody:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetAccountingContactsResponse:
    http_meta: components_httpmetadata.HTTPMetadata = dataclasses.field(metadata={'dataclasses_json': { 'exclude': lambda f: True }})
    object: Optional[GetAccountingContactsResponseBody] = dataclasses.field(default=None)
