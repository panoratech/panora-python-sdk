...
class GetPurchaseOrderRequest:
    ...
    r"""id of the purchaseorder you want to retrieve."""
...
@dataclasses.dataclass
class GetPurchaseOrderResponseBody:
...
class GetPurchaseOrderResponse:
    ...
    object: Optional[GetPurchaseOrderResponseBody] = dataclasses.field(default=None)
