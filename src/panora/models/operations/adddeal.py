...
class AddDealRequest:
    ...
    unified_deal_input: components_unifieddealinput.UnifiedDealInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class AddDealResponse:
    ...
    object: Optional[AddDealResponseBody] = dataclasses.field(default=None)
    unified_deal_output: Optional[components_unifieddealoutput.UnifiedDealOutput] = dataclasses.field(default=None)
