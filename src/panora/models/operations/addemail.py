...
class AddEmailRequest:
    ...
    unified_email_input: components_unifiedemailinput.UnifiedEmailInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class AddEmailResponse:
    ...
    object: Optional[AddEmailResponseBody] = dataclasses.field(default=None)
    unified_email_output: Optional[components_unifiedemailoutput.UnifiedEmailOutput] = dataclasses.field(default=None)
