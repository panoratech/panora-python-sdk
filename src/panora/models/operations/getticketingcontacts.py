...
class GetTicketingContactsRequest:
...
@dataclasses.dataclass
class GetTicketingContactsResponseBody:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetTicketingContactsResponse:
    http_meta: components_httpmetadata.HTTPMetadata = dataclasses.field(metadata={'dataclasses_json': { 'exclude': lambda f: True }})
    object: Optional[GetTicketingContactsResponseBody] = dataclasses.field(default=None)
