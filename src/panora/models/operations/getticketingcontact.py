...
class GetTicketingContactRequest:
...
@dataclasses.dataclass
class GetTicketingContactResponseBody:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetTicketingContactResponse:
    http_meta: components_httpmetadata.HTTPMetadata = dataclasses.field(metadata={'dataclasses_json': { 'exclude': lambda f: True }})
    object: Optional[GetTicketingContactResponseBody] = dataclasses.field(default=None)
