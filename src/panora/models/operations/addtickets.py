...
class AddTicketsRequest:
    ...
    request_body: List[components_unifiedticketinput.UnifiedTicketInput] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AddTicketsResponse:
    http_meta: components_httpmetadata.HTTPMetadata = dataclasses.field(metadata={'dataclasses_json': { 'exclude': lambda f: True }})
    object: Optional[AddTicketsResponseBody] = dataclasses.field(default=None)
    unified_ticket_outputs: Optional[List[components_unifiedticketoutput.UnifiedTicketOutput]] = dataclasses.field(default=None)
