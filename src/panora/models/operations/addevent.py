...
class AddEventRequest:
    ...
    unified_event_input: components_unifiedeventinput.UnifiedEventInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class AddEventResponse:
    ...
    object: Optional[AddEventResponseBody] = dataclasses.field(default=None)
    unified_event_output: Optional[components_unifiedeventoutput.UnifiedEventOutput] = dataclasses.field(default=None)
