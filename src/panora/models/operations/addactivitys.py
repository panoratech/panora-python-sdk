...
from ...models.components import unifiedactivityinput as components_unifiedactivityinput
...
class AddActivitysRequest:
    ...
    request_body: List[components_unifiedactivityinput.UnifiedActivityInput] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
@dataclasses.dataclass
class AddActivitysResponseBody:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AddActivitysResponse:
    http_meta: components_httpmetadata.HTTPMetadata = dataclasses.field(metadata={'dataclasses_json': { 'exclude': lambda f: True }})
    object: Optional[AddActivitysResponseBody] = dataclasses.field(default=None)
    unified_activity_outputs: Optional[List[components_unifiedactivityoutput.UnifiedActivityOutput]] = dataclasses.field(default=None)
