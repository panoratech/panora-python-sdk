...
class AddPurchaseOrdersRequest:
    ...
    request_body: List[components_unifiedpurchaseorderinput.UnifiedPurchaseOrderInput] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
@dataclasses.dataclass
class AddPurchaseOrdersResponseBody:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AddPurchaseOrdersResponse:
    http_meta: components_httpmetadata.HTTPMetadata = dataclasses.field(metadata={'dataclasses_json': { 'exclude': lambda f: True }})
    object: Optional[AddPurchaseOrdersResponseBody] = dataclasses.field(default=None)
    unified_purchase_order_outputs: Optional[List[components_unifiedpurchaseorderoutput.UnifiedPurchaseOrderOutput]] = dataclasses.field(default=None)
