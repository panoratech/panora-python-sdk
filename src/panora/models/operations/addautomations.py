...
class AddAutomationsRequest:
    ...
    request_body: List[components_unifiedautomationinput.UnifiedAutomationInput] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
@dataclasses.dataclass
class AddAutomationsResponseBody:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AddAutomationsResponse:
    http_meta: components_httpmetadata.HTTPMetadata = dataclasses.field(metadata={'dataclasses_json': { 'exclude': lambda f: True }})
    object: Optional[AddAutomationsResponseBody] = dataclasses.field(default=None)
    unified_automation_outputs: Optional[List[components_unifiedautomationoutput.UnifiedAutomationOutput]] = dataclasses.field(default=None)
