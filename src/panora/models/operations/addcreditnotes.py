...
class AddCreditNotesRequest:
    ...
    request_body: List[components_unifiedcreditnoteinput.UnifiedCreditNoteInput] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
@dataclasses.dataclass
class AddCreditNotesResponseBody:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AddCreditNotesResponse:
    http_meta: components_httpmetadata.HTTPMetadata = dataclasses.field(metadata={'dataclasses_json': { 'exclude': lambda f: True }})
    object: Optional[AddCreditNotesResponseBody] = dataclasses.field(default=None)
    unified_credit_note_outputs: Optional[List[components_unifiedcreditnoteoutput.UnifiedCreditNoteOutput]] = dataclasses.field(default=None)
