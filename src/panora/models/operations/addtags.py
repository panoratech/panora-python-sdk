...
class AddTagsRequest:
    ...
    request_body: List[components_unifiedtaginput.UnifiedTagInput] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class AddTagsResponse:
    ...
    object: Optional[AddTagsResponseBody] = dataclasses.field(default=None)
    unified_tag_outputs: Optional[List[components_unifiedtagoutput.UnifiedTagOutput]] = dataclasses.field(default=None)
