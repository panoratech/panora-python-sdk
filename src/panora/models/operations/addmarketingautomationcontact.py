...
class AddMarketingAutomationContactRequest:
...
@dataclasses.dataclass
class AddMarketingAutomationContactResponseBody:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AddMarketingAutomationContactResponse:
    http_meta: components_httpmetadata.HTTPMetadata = dataclasses.field(metadata={'dataclasses_json': { 'exclude': lambda f: True }})
    object: Optional[AddMarketingAutomationContactResponseBody] = dataclasses.field(default=None)
