...
class GetMarketingAutomationEventsRequest:
...
@dataclasses.dataclass
class GetMarketingAutomationEventsResponseBody:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetMarketingAutomationEventsResponse:
    http_meta: components_httpmetadata.HTTPMetadata = dataclasses.field(metadata={'dataclasses_json': { 'exclude': lambda f: True }})
    object: Optional[GetMarketingAutomationEventsResponseBody] = dataclasses.field(default=None)
