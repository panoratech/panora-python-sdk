...
import dataclasses
from .unifiedattachmentoutput import UnifiedAttachmentOutput
...
class UnifiedCommentOutputRemoteData:
    pass


@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class UnifiedCommentOutput:
    body: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('body') }})
    r"""The body of the comment"""
    remote_data: UnifiedCommentOutputRemoteData = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('remote_data') }})
    ...
    attachments: Optional[List[UnifiedAttachmentOutput]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('attachments'), 'exclude': lambda f: f is None }})
    r"""The attachemnets tied to the comment"""
