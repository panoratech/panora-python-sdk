...
class UnifiedEngagementOutputFieldMappings:
    pass


@dataclasses.dataclass
class UnifiedEngagementOutputRemoteData:
    pass


@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class UnifiedEngagementOutput:
    type: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""The type of the engagement. Authorized values are EMAIL, CALL or MEETING"""
    field_mappings: UnifiedEngagementOutputFieldMappings = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('field_mappings') }})
    remote_data: UnifiedEngagementOutputRemoteData = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('remote_data') }})
