...
class CrmTasks:
    ...
    def get_tasks(self, x_connection_token: str, remote_data: Optional[bool] = None, limit: Optional[float] = None, cursor: Optional[str] = None) -> operations.GetTasksResponse:
